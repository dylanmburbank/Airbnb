...
In initial steps of the project, we used various modeling methods in R to predict high booking rate of listings on Airbnb data.
In latter steps, we were tasked with exploring causal discovery of high booking rate of data specific to Hawaii market.
