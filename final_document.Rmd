...
#author: "Team 1: Claire Plourde, Dylan Burbank, Yujie Zheng,sahithya koneru"
#date: "May 16th, 2024"
output:
  pdf_document:
    keep_tex: true
...
Our exploratory data analysis of the Hawaii accommodation listings overall revealed several key insights. We first analyzed the listings overall before diving deeper into each island. Firstly, the island significantly influences booking rates. Maui has the highest high booking rate at just over 12% of listings and Molokai has the lowest at 5% of listings.
...
# Boxplot for comparing a numeric and categorical variable
ggplot(hawaii_data, aes(x = room_type, y = price)) +
  geom_boxplot()

# Correlation plot between two numeric variables
